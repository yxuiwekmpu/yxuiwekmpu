...
public class DictManagerUtil {
	 ...
	 * 
	 */
	public static ImmutableMap<Long, CodeItem> buildChildItemMap(List<CodeItem> codeItemList) {
		return Maps.uniqueIndex(codeItemList, new Function<CodeItem, Long>() {
			@Override
